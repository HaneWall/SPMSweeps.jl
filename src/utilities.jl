...
function update_basis!(b::Array{Float64}, bases::Array{Function}, psi::Float64)
  @inbounds for idx in eachindex(bases)
    b[idx] = bases[idx](psi)
  end
end

function error_lms(data::Float64, weights::Array{Float64}, b::Array{Float64})
  return data - dot(weights, b)
end

function update_weights!(w::Array{Float64}, b::Array{Float64}, data::Float64, mu::Float64)
  fact = inv(dot(b, b))
